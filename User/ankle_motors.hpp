 ...
 * @brief driver for dynamixel ripped from some github repo
 * 
 * @version 0.1
 * @date 2024-11-09
 * 
...
/* example usage */
/*
	servo_motor_ct.set_led(0x01, 0x01);
	dynamixel_ax_12A_parameters::Turn_direction_st direction = dynamixel_ax_12A_parameters::RIGHT;
	servo_motor_ct.set_endless_turn(0x01, 50.0, direction);
	HAL_Delay(2000);
	servo_motor_ct.set_led(0x01, 0x00);
	direction = dynamixel_ax_12A_parameters::LEFT;
	servo_motor_ct.set_endless_turn(0x01, 50.0, direction);
	HAL_Delay(2000);
*/
...
#define MODEL_NUMBER_H_ADR							0x01 // Access : RD , -  Initial Value: 0   (0x00)
